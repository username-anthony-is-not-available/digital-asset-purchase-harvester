...
def test_coinspot_multi_extractor():
    """Test CoinSpot extractor with multiple transactions in one email."""
...
def test_swyftx_multi_extractor():
    """Test Swyftx extractor with multiple transactions in one email."""
    from digital_asset_harvester.processing.extractors import registry
...
def test_newton_multi_extractor():
    """Test Newton extractor with multiple transactions in one email."""
    from digital_asset_harvester.processing.extractors import registry
